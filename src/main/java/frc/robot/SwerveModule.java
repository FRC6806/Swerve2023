...
public class SwerveModule {
    ...
    public SwerveModule(int moduleNumber, SwerveModuleConstants moduleConstants){
        ...
        mDriveMotor.setInverted(moduleConstants.motorReversed);
        configDriveMotor();
    ...
    public void setDesiredState(SwerveModuleState desiredState, boolean isOpenLoop){
        ...
        if(isOpenLoop){
            ...
            SmartDashboard.putNumber("Velocity"+moduleNumber, velocity);
       ...
       mAngleMotor.set(ControlMode.Position, Conversions.degreesToFalcon(angle, Constants.Swerve.angleGearRatio)); 
        //mAngleMotor.setSelectedSensorPosition(Conversions.degreesToFalcon(angle, Constants.Swerve.angleGearRatio)); 
        lastAngle = angle;
        SmartDashboard.putNumber("Angle", angle);
        SmartDashboard.putNumber( "MotorPos"+moduleNumber, mAngleMotor.getSelectedSensorPosition(0));
        SmartDashboard.putNumber("MotorSpeed"+moduleNumber, desiredState.speedMetersPerSecond);
        SmartDashboard.putNumber("degreesToFalcon"+moduleNumber, Conversions.degreesToFalcon(angle, Constants.Swerve.angleGearRatio));
    }
    ...
    private void resetToAbsolute(){
        ...
        mAngleMotor.setSelectedSensorPosition(absolutePosition);//absolutePosition
    }
    ...
    public void turn90(){
        double angle = 90;
        //mAngleMotor.set( ControlMode.PercentOutput, .3 ); 
         mAngleMotor.set(ControlMode.Position, Conversions.degreesToFalcon(angle, Constants.Swerve.angleGearRatio)); 
        //mAngleMotor.setSelectedSensorPosition(Conversions.degreesToFalcon(angle, Constants.Swerve.angleGearRatio)); 
    }
